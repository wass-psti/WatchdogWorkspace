...
has(continuationState, 'Certification-Ready Checkpoint 31', 'M47 continuation handoff identifies the current checkpoint');
...
has(releaseStatus, 'Checkpoint 31 committed Board-payload readiness corrective', 'M47 release status records the hosted historical browser-readiness corrective');
has(continuationState, 'PASS — 285 static checks', 'M47 continuation summary reports the current static authority count');
has(continuationState, 'PASS — 50 checks', 'M47 continuation summary reports the current deterministic authority count');
has(releaseStatus, 'Current M47 static verifier: **PASS (285 checks)**', 'M47 release summary reports the current static authority count');
