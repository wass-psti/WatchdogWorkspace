-- Work Management v1.43.2 — Stage G M54 production capability parity corrective.
-- Synchronizes public.wm_runtime_capabilities() with the M51 CAS RPC required by the current client capability manifest.
begin;
