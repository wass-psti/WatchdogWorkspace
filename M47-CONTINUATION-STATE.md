# Stage G M47 — Boards Table / Group / Item Recovery — Certification-Ready Checkpoint 29

Status: implementation complete pending final certification; production already carries the exact M47 migration and live semantic attestation is compatible. GitHub `main` is already on published M47 source commit `8daeb2679d19fd4c41dc9cd13b625542c5f854ee`, whose dedicated M47 hosted certification succeeded and produced a certified artifact. Checkpoint 29 is a corrective certification-resume checkpoint on top of that published M47 commit; it forbids migration replay and forbids republishing the original 49-path M47 source set.

Overall M47 completion at this checkpoint: 99% implementation-corrected/certification-ready. The official four-scenario browser gate is now PASS, the 34-assertion M47 pgTAP authority is PASS, retained M44 browser authority is 2/2 PASS, production migration `20260919165239_stage_g_m47_boards_table_group_item_recovery.sql` is applied and semantically attested, and the M47 hosted workflow/artifact for `8daeb2679d19fd4c41dc9cd13b625542c5f854ee` succeeded. The remaining failures are historical/governance regressions exposed by that publication: M45 and M46 finalizer self-tests copied already-active historical targets into pending-only certification fixtures, and the global M29 Database/RLS suite still encoded pre-M46 SECURITY DEFINER assumptions. Checkpoint 29 corrects only those historical test authorities and binds them into the M47 candidate gate. Final PASS remains pending a small corrective commit on top of `8daeb267…`, exact-commit local certification, successful affected hosted regressions, hosted M47 artifact verification, and final remote binding.

Current dependency-free authority: **PASS — 269 static checks**, **PASS — 50 deterministic checks**, and **PASS — 62 workflow checks**. M45/M46 finalizer fail-closed self-tests pass with synthetic pending fixtures while the real M45/M46 finalizers remain pending-only. The M47 candidate now additionally requires M45 workflow/finalizer, M46 finalizer, and disposable global Database/RLS regression gates before publication.
...
- M47 static verifier: **PASS — 231 checks; architecture 55 synchronized; 34 governed DB assertions and 4 governed browser scenarios declared**.
