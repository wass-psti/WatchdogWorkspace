...
export function renderBoardColumnHeader({ column, canEdit, sort, filter, wrapped, currentWidth, columnTypeLabel, escapeHtml, logicalColumnIndex = 0 }: BoardColumnHeaderRenderOptions): string {
  const esc = escapeHtml;
