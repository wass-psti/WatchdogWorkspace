...
check(browser.includes("body?.p_name).toBe('M45 Created Board')"),'browser suite proves the create RPC carried the requested Board name before detail readiness assertions');
