  ...
  return <>
    ...
    <main id="main" className="page account-page" data-wm-management-view="account" tabIndex={-1}>
      ...
      <section className="settings-card settings-secondary">
        ...
        <div className="settings-row account-form-row"><div><span>SECURITY</span><h2>Change password</h2><p>A successful password change signs out every active Work Management session and requires a fresh login.</p></div><form className="inline-account-form password-form" data-wm-management-form="password" onSubmit={submitPassword}><label className="wm-visually-hidden" htmlFor="wm-account-new-password">New password</label><input id="wm-account-new-password" name="password" type="password" autoComplete="new-password" minLength={10} placeholder="New password" required /><label className="wm-visually-hidden" htmlFor="wm-account-confirm-password">Confirm password</label><input id="wm-account-confirm-password" name="confirmPassword" type="password" autoComplete="new-password" minLength={10} placeholder="Confirm password" required /><BusyButton type="submit" className="secondary-btn" busy={busy.has('change-password')}>Change password</BusyButton></form></div>
